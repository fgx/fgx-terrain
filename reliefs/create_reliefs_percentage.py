...
#                                                                                    
#   (c) 2012, Yves Sablonier, yves.at.sablonier.ch                                   
#                                                                                    
...
def imageworkparam(shiftedfilenamex,mergelist):
	...
	hillshadeparam3 = "composite -compose Multiply "+tempdir+"/relief1_"+shiftedfilenamex+".tif "+tempdir+"/relief2_"+shiftedfilenamex+".tif "+tempdir+"/multiply_"+shiftedfilenamex+".tif"
	...
	coastlineparam3 = "convert -blur 1x0.5 "+tempdir+"/coastline1_"+shiftedfilenamex+".tif "+tempdir+"/blur_"+shiftedfilenamex+".tif"
	
	
	# Do some work on the relief
	imageshackparam1 = "composite -compose Multiply "+tempdir+"/relief1_"+shiftedfilenamex+".tif "+tempdir+"/relief2_"+shiftedfilenamex+".tif "+tempdir+"/multiply_"+shiftedfilenamex+".tif" 
	imageshackparam2 = "convert "+tempdir+"/multiply_"+shiftedfilenamex+".tif  -size 1x1 xc:'rgb(204,153,51)' -fx '1-(1-v.p{0,0})*(1-u)' "+tempdir+"/multiply_"+shiftedfilenamex+".tif" 
	imageshackparam3 = "composite -compose Darken "+tempdir+"/multiply_"+shiftedfilenamex+".tif "+tempdir+"/relief1_"+shiftedfilenamex+".tif "+tempdir+"/darken_"+shiftedfilenamex+".tif"
	imageshackparam4 = "convert -modulate 120,100 "+tempdir+"/darken_"+shiftedfilenamex+".tif "+tempdir+"/darken_mod_"+shiftedfilenamex+".tif"
	imageshackparam5 = "convert "+tempdir+"/darken_mod_"+shiftedfilenamex+".tif  -fill white -colorize 70%  "+tempdir+"/finish_"+shiftedfilenamex+".tif"
	
	# Bring it all together
	
	# don't need the blur here?
	finishparam1 = "composite -compose Darken "+tempdir+"/finish_"+shiftedfilenamex+".tif "+tempdir+"/blur_"+shiftedfilenamex+".tif "+tempdir+"/end1_"+shiftedfilenamex+".tif"
	# without the blur
	...
	finishparam2 = "composite -compose Multiply "+tempdir+"/end1_"+shiftedfilenamex+".tif "+tempdir+"/coastline2_"+shiftedfilenamex+".tif "+tempdir+"/end2_"+shiftedfilenamex+".tif"	
...
def countnortheast():
	...
	for i in range(18):
		...
		rasterparam = "gdal_rasterize -of GTiff -ot UInt16 -a shapeid -ts 6001 6001 -l "+shiftedfilenamex+" "+tempdir+"/"+shiftedfilenamex+".shp "+tempdir+"/"+shiftedfilenamex+".tif"
